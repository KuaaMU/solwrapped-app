...
export function ReportClient({ address }: { address: string }) {
    ...
    >
      ...
      <AnimatePresence>
        ...
        >
          ...
          >
            <div className="flex items-center gap-3 w-full justify-between text-[var(--text-disabled)] text-[9px] font-mono uppercase tracking-[0.25em]">
